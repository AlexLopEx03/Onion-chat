...
$remoteAppPath = "https://github.com/AlexLopEx03/Onion-chat/releases/latest/download/onion-chat.exe"
$remoteTorPath = "https://github.com/AlexLopEx03/Onion-chat/releases/latest/download/tor-expert-bundle-windows-x86_64.tar.gz"
